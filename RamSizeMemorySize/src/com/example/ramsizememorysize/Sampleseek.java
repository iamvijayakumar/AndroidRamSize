...
public class Sampleseek extends View {
	...
	private static final float DEFAULT_POINTER_HALO_WIDTH = 10f;
	private static final float DEFAULT_POINTER_HALO_BORDER_WIDTH = 10f;
	...
	public Sampleseek(Context context) {
		super(context);
		init(null, 0);
	}

	public Sampleseek(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public Sampleseek(Context context, AttributeSet attrs, int defStyle) {
	...
	*/
	public interface OnCircularSeekBarChangeListener {
		...
		public abstract void onProgressChanged(Sampleseek circularSeekBar, int progress, boolean fromUser);

		public abstract void onStopTrackingTouch(Sampleseek seekBar);

		public abstract void onStartTrackingTouch(Sampleseek seekBar);
	}
